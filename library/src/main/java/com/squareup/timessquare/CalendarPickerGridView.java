...
/**
 * Created by Simone on 05/10/15.
 */
public class CalendarPickerGridView extends GridView {
    ...
    private final CalendarPickerGridView.MonthAdapter adapter;
    ...
    public CalendarPickerGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private class MonthAdapter extends BaseAdapter {
        ...
        @Override public View getView(int position, View convertView, ViewGroup parent) {
            ...
            monthView.init(months.get(position), cells.get(position), displayOnly, titleTypeface,
                    dateTypeface, titleMonthToUpper, gravityTitleHeaderMonth, typefaceCellDays, true);
            return monthView;
        }
    }
    ...
    public void setColorCellDisabled(int colorCellDisabled) {
        this.colorCellDisabled = colorCellDisabled;
    }
